...
<body>
  ...
  <section id="registration-page" class="container">
    <form class="center" action="updatebill1.jsp" method="POST">
      <fieldset class="registration-form">
        <div class="control-group">
          <!-- paydate -->
          <div class="controls">
            <input type="text" id="paydate" name="paydate" placeholder="pdate(dd-mm-yyyy)" class="input-xlarge">
          </div>
        </div>
        <div class="control-group">
          <!-- pmode -->
          <div class="controls">
            <input type="text" id="mode" name="mode" placeholder="pmode" class="input-xlarge">
          </div>
        </div>
         <%
		 ...
		 session.removeAttribute("bill");
          ...
          <!-- pstatus -->
          <div class="controls">
            <input type="text" id="status" name="status" placeholder="pstatus" class="input-xlarge">
          </div>
        </div>
        <div class="control-group">
          <!-- billid -->
          <div class="controls">
            <input type="text" id="bill" name="bill" placeholder="bill" class="input-xlarge">
          </div>
        </div>
        <div class="control-group">
          <!-- Button -->
