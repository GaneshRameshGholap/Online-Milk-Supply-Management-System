...
<body>
      ...
      <div class="row-fluid">
        ...
        <div class="span6">
          <ul class="breadcrumb pull-right">
            <li><a href="index.html">Customer Home</a> <span class="divider">/</span></li>
  ...
  <section id="registration-page" class="container">
    <form class="center" action='updateCust.jsp' method="POST">
      <fieldset class="registration-form">
        <div class="control-group">
          
            <!-- cid-->
          <div class="controls">
            <input type="text" id="cid" name="cid" placeholder="Customer Id" class="input-xlarge">
          </div>
        </div>		  

		  <!-- customer fname -->
          <div class="controls">
            <input type="text" id="fname" name="fname" placeholder="Customer FirstName" class="input-xlarge">
          </div>
        </div>
	
            <!-- customer lname -->
          <div class="controls">
            <input type="text" id="lname" name="lname" placeholder="Customer LastName" class="input-xlarge">
          </div>
        </div>
		<!--Customer address -->
          <div class="controls">
            <input type="text" id="add" name="add" placeholder="Address" class="input-xlarge">
          </div>
        </div>
          <!-- customer email -->
          <div class="controls">
            <input type="text" id="email" name="email" placeholder="Customer Email" class="input-xlarge">
          </div>
        </div>
          <!-- customer contact -->
          <div class="controls">
            <input type="text" id="contact" name="contact" placeholder="Customer Contact" class="input-xlarge">
          </div>
        </div>
          <!-- customer Type-->
          <div class="controls">
            <input type="text" id="ctype" name="ctype" placeholder="Customer Type" class="input-xlarge">
          </div>
        </div>
          <!-- customer city-->
          <div class="controls">
            <input type="text" id="city" name="city" placeholder="Customer City" class="input-xlarge">
          </div>
        </div>
          <!-- customer rate-->
          <div class="controls">
            <input type="text" id="rate" name="rate" placeholder="Customer rate" class="input-xlarge">
          </div>
        </div>
          <!-- customer Qty -->
          <div class="controls">
            <input type="text" id="qty" name="qty" placeholder="Customer Milk_Qty" class="input-xlarge">
          </div>
        </div>
          <!-- customer password-->
          <div class="controls">
            <input type="password" id="pwd" name="pwd" placeholder="Customer Password" class="input-xlarge">
          </div>
        </div>
          <!-- customer Eid -->
          <div class="controls">
            <input type="text" id="eid" name="eid" placeholder="Employee id" class="input-xlarge">
          </div>
        </div>
        <div class="control-group">
          <!-- Button -->
        ...
        <%
         ...
         <%
           ...
           if(session.getAttribute("bill1")!=null)
           {
             session.removeAttribute("bill1");
         %>
         <script>
         alert("Not Updated");
         </script>
