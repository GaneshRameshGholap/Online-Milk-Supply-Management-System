...
try
{
	...
	else
	{
		...
		out.println("<center><table border=2><tr><th>First Name</th><th>Last Name</th><th>Address</th><th>email</th><th>contact</th><th>ctype</th><th>city</th><th>milk_qty</th><th>password</th></tr>");
		...
		while(res.next())
		{
			...
			out.println("<tr><td>"+str1+"</td><td>"+str2+"</td><td>"+str3+"</td><td>"+str4+"</td><td>"+str5+"</td><td>"+str6+"</td><td>"+str7+"</td><td>"+f+"</td><td>"+str8+"</td></tr>");
    ...
    <form class="center" action="temp1.jsp" method="POST">
      <fieldset class="registration-form">
        <div class="control-group">
          <!-- Date -->
          <div class="controls">
            <input type="text" id="cid" name="cid" placeholder="cid" class="input-xlarge">
            <input type="text" id="first" name="first" placeholder="first" class="input-xlarge">
            <input type="text" id="last" name="last" placeholder="last" class="input-xlarge">
            ...
            <input type="text" id="contact" name="contact" placeholder="contact" class="input-xlarge">
            <input type="text" id="ctype" name="ctype" placeholder="ctype" class="input-xlarge">
            <input type="text" id="city" name="city" placeholder="city" class="input-xlarge">
            <input type="text" id="rate" name="rate" placeholder="rate" class="input-xlarge">
            <input type="text" id="qty" name="qty" placeholder="qty" class="input-xlarge">
            <input type="text" id="password" name="password" placeholder="password" class="input-xlarge">
            <input type="text" id="eid" name="eid" placeholder="eid" class="input-xlarge">
		 ...
		 session.removeAttribute("temp");
          ...
          <%
           ...
           %>
            <script>
            alert("Record Deleted from temp");
            </script>
           <%
             }
          %>
