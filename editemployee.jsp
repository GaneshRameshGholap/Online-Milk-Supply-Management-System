...
<body>
            ...
            <div class="container">
                ...
                <div class="nav-collapse collapse pull-right">
                    <ul class="nav">
						...
						<li><a href="viewquantity.html">View Quantity</a></li>
      ...
      <div class="row-fluid">
        ...
        <div class="span6">
          <ul class="breadcrumb pull-right">
            <li><a href="index.html">Emloyee Home</a> <span class="divider">/</span></li>
  ...
  <section id="registration-page" class="container">
    <form class="center" action='updateEmpp.jsp' method="POST">
      <fieldset class="registration-form">

        <div class="control-group">
           <!-- employee id -->
          <div class="controls">
            <input type="text" id="eid" name="eid" placeholder="Emloyee Id" class="input-xlarge">
          </div>
        </div>
         <div class="control-group">
          <!-- employee name -->
          <div class="controls">
            <input type="text" id="ename" name="ename"  placeholder="Employee Name" class="input-xlarge">
          </div>
        </div>
          ...
          <!-- employee address -->
          <div class="controls">
            <input type="text" id="eaddress" name="eaddress" placeholder="Address" class="input-xlarge">
          </div>
        </div>
        ...
        <!-- contact number -->
          <div class="controls">
            <input type="text" id="contact" name="contact"  placeholder="Mobile Number" class="input-xlarge">
          </div>
        </div>
         ...
         <!-- employee name -->
          <div class="controls">
            <input type="text" id="city" name="city"  placeholder="Emloyee City" class="input-xlarge">
          </div>
        </div>
        ...
        <div class="control-group">
         ...
         <%
           if(session.getAttribute("upd")!=null)
           {
                session.removeAttribute("upd");
         %>
          <script>
         ...
         <%
          ...
          if(session.getAttribute("upd1")!=null)
          {
            session.removeAttribute("upd1"); 
         %>
         <script>
           alert("Not Updated");
         </script>
