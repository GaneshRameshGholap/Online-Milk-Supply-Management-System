...
<body>
  ...
  <section id="registration-page" class="container">
    <form class="center" action="updateAttend.jsp" method="POST">
      <fieldset class="registration-form">
		...
		<div class="control-group">
		  ...
		  <!-- quantity -->
          <div class="controls">
            <input type="text" id="qty" name="qty" placeholder="Quantity" class="input-xlarge">
          </div>
        </div>
		...
		<div class="control-group">
		  <!-- date -->
          <div class="controls">
            <input type="date" id="date" name="date" placeholder="Date(dd-mm-yyyy)" class="input-xlarge">
          </div>
        </div>
        <%
        ...
        <%
         ...
         if(session.getAttribute("attend2")!=null)
          {
             session.removeAttribute("attend2");
        %>
         <script>
        ...
        <div class="control-group">
          <!-- Button -->
          <div class="controls">
            <button class="btn btn-success btn-large btn-block">Update Attendance</button>
          </div>
        </div>
      </fieldset>
    </form>
