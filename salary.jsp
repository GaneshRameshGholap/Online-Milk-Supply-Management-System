...
<body>
  ...
  <section id="registration-page" class="container">
    <form class="center" action="bill3.jsp" method="POST">
      <fieldset class="registration-form">
        ...
        <div class="control-group">
          <!-- from -->
          <div class="controls">
            <input type="text" id="from" name="from" placeholder="from(dd-mm-yyyy)" class="input-xlarge">
          </div>
        </div>
        <div class="control-group">
          <!-- to -->
          <div class="controls">
            <input type="text" id="to" name="to" placeholder="to(dd-mm-yyyy)" class="input-xlarge">
          </div>
        </div>
         <div class="control-group">
          <!-- month -->
          <div class="controls">
            <input type="text" id="month" name="month" placeholder="month" class="input-xlarge">
          </div>
        </div>
         <div class="control-group">
          <!-- year -->
          <div class="controls">
            <input type="text" id="year" name="year" placeholder="year" class="input-xlarge">
          </div>
        </div>
       <%
            if(session.getAttribute("sal")!=null)
            {
        ...
        <%
           ...
           if(session.getAttribute("sal1")!=null)
          {
           session.removeAttribute("sal1");
               
         %>
          <script>
          alert("Salary not Generated");
           </script>
          <%
            }
            %>
        <div class="control-group">
          <!-- rate -->
          <div class="controls">
            <input type="text" id="rate" name="rate" placeholder="Rate Per Milk" class="input-xlarge">
          </div>
        </div>
        <div class="control-group">
          <!-- Button -->
