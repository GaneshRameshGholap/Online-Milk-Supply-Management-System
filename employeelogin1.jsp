...
<body>
      ...
      <div class="row-fluid">
        ...
        <div class="span6">
          <ul class="breadcrumb pull-right">
            ...
            <li class="active">Login</li><span class="divider">/</span></li>
  ...
  <section id="registration-page" class="container">
    <form class="center" action="employeelogin.jsp" method="POST">
      <fieldset class="registration-form">
	 <div class="control-group">
          <!-- LoginId -->
          <div class="controls">
            <input type="text" id="loginid" name="loginid" placeholder="Login Id" class="input-xlarge">
          </div>
        </div>
	 ...
	 <%
          ...
          %>
           ...
           <%
            ...
            if(session.getAttribute("wrong_uname_pass1")!=null)
            {
             session.removeAttribute("wrong_uname_pass1");
            %>
            <script>
             alert("invalid username or password");
            </script>
