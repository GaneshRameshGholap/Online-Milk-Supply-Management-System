...
<body>
  ...
  <section id="registration-page" class="container">
    <form class="center" action="emp1.jsp" method="POST">
      <fieldset class="registration-form">
       <div class="control-group">
          <!--Employee Id-->
          <div class="controls">
            <input type="text" id="empid" name="empid" placeholder="Employee Id" class="input-xlarge">
          </div>
        </div>
        <div class="control-group">
          <!-- Employee Name -->
          <div class="controls">
            <input type="text" id="empname" name="empname" placeholder="Employee Name" class="input-xlarge">
          </div>
        </div>
        <div class="control-group">
          <!-- Address -->
          <div class="controls">
            <input type="text" id="empaddress" name="empaddress" placeholder="Employee Address" class="input-xlarge">
          </div>
        </div>
        <div class="control-group">
          <!-- E-mail -->
          <div class="controls">
            <input type="text" id="empemail" name="empemail" placeholder="Employee E-mail" class="input-xlarge">
          </div>
        </div>
         <div class="control-group">
          <!-- Contact -->
          <div class="controls">
            <input type="text" id="empcontact" name="empcontact" placeholder="Contact" class="input-xlarge">
          </div>
        </div>
         <div class="control-group">
          <!-- City-->
